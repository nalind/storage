...
var (
	...
	ErrSizeUnknown = baseerrors.New("size is not known")
	// ErrDigestUnknown is returned when the caller asks for the digest of a big data item, but the Store couldn't determine the answer.
